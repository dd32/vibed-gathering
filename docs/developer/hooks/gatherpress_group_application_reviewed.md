...
- [includes/core/classes/class-group-application.php:428](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/class-group-application.php#L428)
```php
