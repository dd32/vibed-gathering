...
- [includes/core/classes/class-group-application.php:426](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/class-group-application.php#L426)
```php
