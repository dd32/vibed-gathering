...
- [includes/core/classes/class-recurrence-generator.php:412](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/class-recurrence-generator.php#L412)
```php
