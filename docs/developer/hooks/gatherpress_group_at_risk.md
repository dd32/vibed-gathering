...
- [includes/core/classes/class-dormancy-detector.php:225](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/class-dormancy-detector.php#L225)
```php
