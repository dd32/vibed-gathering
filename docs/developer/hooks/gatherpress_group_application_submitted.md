...
- [includes/core/classes/class-group-application.php:349](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/class-group-application.php#L349)
```php
