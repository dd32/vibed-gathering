...
- [includes/core/classes/class-dormancy-detector.php:272](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/class-dormancy-detector.php#L272)
```php
