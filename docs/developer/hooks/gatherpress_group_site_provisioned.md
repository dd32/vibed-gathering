...
- [includes/core/classes/class-group-application.php:507](https://github.com/GatherPress/gatherpress/blob/develop/includes/core/classes/class-group-application.php#L507)
```php
